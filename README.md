# サバ活 — 法的ドキュメント (Legal Documents)

サバイバルゲーム戦績記録アプリ **「サバ活」** のプライバシーポリシーおよび
特定商取引法に基づく表示を GitHub Pages で公開するためのリポジトリです。
アプリ内（「このアプリについて」「購入画面」）と App Store / Google Play の
ストア掲載情報から参照されます。
...
1. `privacy-policy.html` / `tokusho.html` を編集
2. commit して push
...
本リポジトリのファイルはサバ活の法的告知文書です。転用・再配布は想定していません。
